...
export function VenueCard({ venue, isPremiumMember, onFavorite, isFavorited, onViewDetails }: VenueCardProps) {
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="p-5">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-xl hover:shadow-lg transition-all"
        >
